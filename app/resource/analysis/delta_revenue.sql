...
get_arr_business_flag AS (
    ...
    SELECT
        ...
        b.ytd_winback_helper,
        b.ytd_reactivation_helper,
        b.ytd_cross_sell_flag,
        b.ytd_upsell_flag,
        b.ytd_downsell_flag

    FROM {{ ref('period_revenue') }} AS p1
    ...
    INNER JOIN
        {{ ref('customer_product_revenue_events') }} AS b
    ...
    SELECT
        ...
        CASE  
            WHEN deactivation_helper = 0 
                AND intermittent_churn_helper = 0 AND lm_product_churn_flag=1
            THEN -arr_lm
            ELSE 0
